<form class="form-horizontal" id="insert_event_form" action="<?php echo base_url(); ?>index.php/main/add_alert" method="post"> 
		  ...
		  <div class="control-group">
            <label class="control-label" for="textarea">Contact Info</label>
            <div class="controls">
              <textarea class="input-xlarge span7" id="textarea" rows="3" name="contact_name" style="resize: none;"></textarea>
            </div>
          </div>
